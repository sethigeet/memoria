...
export function Sidebar({
  ...
  const renderFolder = (folder: FolderWithChildren, depth: number) => {
    ...
    return (
      <div key={folder._id}>
        <div
          className={`group flex items-center gap-1.5 py-1.5 rounded-md text-[13px] transition-colors mx-1.5 my-0.5 whitespace-nowrap pr-2 ${
        ...
        >
          <button
            ...
            className={`w-4 h-4 flex items-center justify-center flex-shrink-0 ${hasChildren ? "cursor-pointer" : "cursor-default"}`}
          >
            {hasChildren ? (
              isExpanded ? (
          ...
          <button
            ...
            className="p-1 rounded opacity-0 group-hover:opacity-100 hover:bg-sidebar-accent"
            title="Add subfolder"
          >
  ...
  return (
    <div
      ref={sidebarRef}
      className="h-screen bg-sidebar border-r border-sidebar-border flex flex-shrink-0 relative"
      style={{ width: sidebarWidth }}
    >
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
      {/* Logo */}
      <div className="p-4 border-b border-sidebar-border flex items-center gap-3 flex-shrink-0">
      ...
      {/* User */}
      <div className="p-3 border-t border-sidebar-border flex items-center gap-2.5 flex-shrink-0">
